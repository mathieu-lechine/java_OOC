...
public class BillTest {
    ...
    private Fridge fridge = new Fridge("BEKO TSE 1042 F", "Réfrigérateur BEKO 130L - Classe A+ - blanc", 101, 130, false);
    ...
    public void Given_3productsAndDelivery_When_generatingBill_Then_getGoodTotal(){
        ...
        assertEquals(779.99, bill.getTotal(), 0.01);
    }
